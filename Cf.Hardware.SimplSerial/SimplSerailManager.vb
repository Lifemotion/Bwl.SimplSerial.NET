...
Public Class SimplSerailManager
    Public Class RequestListItem
        Public Property Request As SSRequest
        Public Property ResponseHandler As ResponseHandlerDelegate
    End Class


    Private _logger As Logger
    Private _cus As New List(Of SimplSerialBus)
    ...
    Public Delegate Sub ResponseHandlerDelegate(source As SimplSerailManager, request As SSRequest, response As SSResponse)
    Public Event RequestListIsEmpty(source As SimplSerailManager)
    ...
    Public Function CheckConnection()
        If _lastPorts <> _portNames.Value Then
            ...
            For Each portName In portNames
                ...
                If portName > "" Then
                    Dim md As New SimplSerialBus(New FastSerialPort())
    ...
    Public Sub AddRequest(request As SSRequest, responseHandler As ResponseHandlerDelegate)
        SyncLock _requestList
    ...
    Public Sub WorkerThreadSub()
        Do
            ...
            If task IsNot Nothing Then
                Try
                    Dim response As New SSResponse With {.ResponseState = ResponseState.errorNotRequested}
    ...
    Private Function GetResponse(request As SSRequest) As SSResponse
